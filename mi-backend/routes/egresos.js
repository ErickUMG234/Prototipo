...
router.post('/', upload.single('solicitud_aprobada'), async (req, res) => {
    try {
        ...
        // Insertar en la tabla egreso_aprobado (el documento aprobado)
        ...
        // Insertar en la tabla Egresos por cada material
        for (const material of materiales) {
            ...
            // Insertar en la tabla Egresos para cada material
            ...
            // Insertar en la tabla Egreso_Material
